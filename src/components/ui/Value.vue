...
<template>
    <section class="relative w-full min-h-screen py-16 md:py-24 bg-gradient-to-b from-sky-50 via-blue-50/30 to-white text-center overflow-hidden">
        ...
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full opacity-20 pointer-events-none">
            <div class="absolute inset-0 bg-gradient-to-r from-sky-300 via-blue-200/50 to-transparent blur-3xl"></div>
        </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
                ...
                <!-- Heading -->
                <h1 class="text-3xl md:text-5xl font-bold text-gray-900 max-w-4xl mx-auto leading-tight mb-12 px-4">
                ...
                <div class="flex flex-col items-center gap-4 md:gap-5">
                    ...
                    >
                        <span :class="`flex items-center justify-center h-10 w-10 rounded-full ${value.color}`">
                            <component :is="value.icon" class="h-5 w-5 text-gray-600" />
                        </span>
                        <span class="text-base font-medium text-gray-800 pr-1">{{ value.text }}</span>
                    </div>
                </div>
