        ...
        <div class="container mx-auto px-4 max-w-screen-xl">
          <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div class="lg:w-1/2 flex flex-col items-start text-left">
              ...
              <button
                class="bg-gradient-to-br from-[#4C7980] to-[#7FACB3]/75 text-white font-semibold px-6 py-3 rounded-lg shadow-md hover:bg-slate-600 transition duration-300 mb-12"
              >
                Book a Call
              </button>
